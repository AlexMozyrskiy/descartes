    ...
    <div>
      {!isDataLoaded ? (
        <>
          ...
          <h2>
            Если Вы хотите, чтобы в телеграмме присутствовали величины отступлений необходимо
            в колонке N (это сразу за колонкой "Ограничение скорости") их вводить. Спасибо.
          </h2>
        </>
      ) : (
